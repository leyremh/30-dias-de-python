...
print("Facebook, Google, Microsoft, Apple, IBM, Oracle".split(','))

print(company[0])
print(len(company) -1)
print(company[10])

palabras= "Phyton For Everyone"
print(palabras[0][0]+palabras[0][1]+palabras[2][0])

palabras2= "Coding For All".split()
print(palabras2[0][0]+palabras2[0][1]+palabras2[2][0])

print("Coding For All".index("C"))
print("Coding For All".index("F"))
print("Coding For People".rfind("l"))
